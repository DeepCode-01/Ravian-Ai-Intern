...
const Footer = () => {
    return (
        <div className="mx-auto container xl:px-20 lg:px-12 sm:px-6 px-4  py-12  bg-gradient-to-t dark:from-black  from-gray-950 dark:to-gray-950 to-gray-900">
            <div className="flex flex-col items-center justify-center">
                <h1 className=" mb-2 text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r  from-[#00c2cb] to-green-600  dark:from-indigo-500 dark:to-purple-500">
                RAVIAN AI
                </h1>
                <div className="flex text-3xl flex-wrap sm:gap-10 gap-8 items-center justify-center mt-8">
                ...
                <div className="flex items-center mt-6">
                    <p className="text-base leading-4 text-gray-500 dark:text-white">
                        2024 &copy; <span className="font-semibold">RAVIAN AI</span>
                    </p>
                    <div className="border-l border-gray-800 dark:text-white pl-2 ml-2">
                        <p className="text-base leading-4 text-gray-500 dark:text-white">Inc. All righys reserved</p>
                    </div>
                </div>
            </div>
        </div>
