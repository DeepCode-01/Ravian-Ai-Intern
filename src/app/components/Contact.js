        ...
        <div className="relative z-10 max-w-screen-xl mx-auto px-4 justify-between items-center gap-12 md:px-8 md:flex">
          ...
          <div className="flex-1 mt-6 md:mt-0">
            ...
            >
              ...
              <button className="block w-auto py-3 px-4 font-medium text-sm text-center  text-white bg-gradient-to-r  from-[#00c2cb] to-green-600  dark:from-indigo-500 dark:to-purple-500 rounded-lg shadow-xl">
                Send
              </button>
            </form>
          </div>
