            ...
            <div className="flex h-full items-center rounded-xl bg-gray-300 shadow-2xl dark:bg-gray-800 p-6 text-center  lg:pl-12 lg:text-left">
              <div className="lg:pl-12">
                ...
                <span className="mb-2 pb-2 lg:pb-0 text-[0.9rem] text-gray-700 font-semibold dark:text-gray-200">
                  As pioneers in the field, we have developed the world leading
                  AI data scientist—an intelligent platform that leads the way
                  in crafting machine learning and deep learning models,
                  conducting comprehensive data analysis, and delivering
                  ...
                  informed decisions that drive success. With a team of
                  passionate experts and a commitment to excellence, we have
                  turned that vision into reality.
                </span>
                <br />
                <br />
                <span className="mb-2 pb-2 lg:pb-0 text-[0.9rem] text-gray-700 font-semibold dark:text-gray-200">
                  EToday, RAVIAN stands at the forefront of AI-driven analytics,
                  helping businesses of all sizes unlock the full potential of
                  their data assets. Whether you are uncovering hidden patterns,
                  predicting future trends, or optimizing operations, RAVIAN AI
                  is your trusted partner in navigating the complexities of
                  data-driven decision-making. Join us on this journey as we
                  continue to push the boundaries of what is possible in the
                  realm of data analytics. Welcome to RAVIAN AI—where innovation
                  meets intelligence.
                </span>
              </div>
            </div>
