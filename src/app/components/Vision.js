...
const Vision = () => {
  return (
    <div id="vision">
      ...
      <div className="2xl:mx-auto 2xl:container md:px-20 px-4 md:py-12 py-9" data-aos="fade-up">
        <div className="relative rounded-md">
          ...
          <div className="text-xl relative w-full h-full z-40 top-0 md:p-16 p-6 flex flex-col justify-between rounded-md "  style={{ background: "linear-gradient(137.92deg, rgba(192, 132, 252, 0) 20.43%, rgba(99, 102, 241, 0.6) 49.66%, rgba(168, 85, 247, 0.6) 49.66%, rgba(204, 171, 238, 0) 92.38%)" }}>
            <div>
              <h1 className="md:text-3xl text-lg font-bold md:leading-10 leading-9 text-white sm:w-auto w-64" data-aos="fade-down">
